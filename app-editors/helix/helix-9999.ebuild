...
inherit cargo desktop git-r3 shell-completion xdg

DESCRIPTION="A post-modern text editor with experimental plugin system"
HOMEPAGE="
	https://helix-editor.com/
	https://github.com/helix-editor/helix
	https://github.com/mattwparas/helix
"
