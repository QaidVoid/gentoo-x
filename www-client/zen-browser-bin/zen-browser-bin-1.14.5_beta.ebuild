...
ZEN_PV="${PV/_beta/b}"
ZEN_P="${ZEN_PN}-${ZEN_PV}"
SRC_BASE_URI="https://github.com/${ZEN_PN}/desktop/releases/download"

DESCRIPTION="Performance oriented Firefox-based web browser"
HOMEPAGE="https://github.com/zen-browser/desktop"
SRC_URI="
	amd64? ( ${SRC_BASE_URI}/${ZEN_PV}/zen.linux-x86_64.tar.xz -> ${ZEN_P}-x86_64.tar.xz )
	arm64? ( ${SRC_BASE_URI}/${ZEN_PV}/zen.linux-aarch64.tar.xz -> ${ZEN_P}-aarch64.tar.xz )
"
